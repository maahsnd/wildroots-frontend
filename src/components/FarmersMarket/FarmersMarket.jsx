...
function FarmersMarket() {
  ...
  useEffect(() => {
    const fetchContent = async () => {
      try {
        const contentRef = dbRef(db, 'general-info/farmersMarket');
  ...
  useEffect(() => {
    const fetchPhotoUrls = async () => {
      try {
        const folderRef = storageRef(storage, 'farmersMarketPhotos'); // Use storageRef to reference the storage folder
